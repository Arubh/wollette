...
export default function Navbar() {
  ...
  return (
    <>
      <div className="container-style items-center justify-center md:flex hidden mt-10 ">
      ...
      {/* <div className="container-style hidden md:flex lg:hidden justify-center items-center">
        <nav className="flex items-center w-full justify-between text-header-mobile-sb transition-all">
          <section className="flex justify-between shrink-0">
            <Image src="/png/logo.png" alt="Picture of the author" width={120} height={120} />
          </section>

          <section className="px-2">
            <ul className="flex justify-between list-none items-center px-[2px] gap-2 mt-3">
              ...
              <li className="group flex justify-center">
                ...
                <svg
                  ...
                  viewBox="0 0 16 16"
                  fill="none"
                  className="mt-[3.6px] ml-[1px] block group-hover:hidden"
                >
                  <path d="M3 6L7.50667 11L12 6" stroke="#131313" strokeWidth="1.5" />
                </svg>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="14"
                  ...
                  viewBox="0 0 16 16"
                  fill="none"
                  className="mt-[3.6px] ml-[1px] hidden group-hover:block"
                >
                  <path d="M3.5 6L8.00667 11L12.5 6" stroke="#0E72E8" strokeWidth="1.5" />
                </svg>
              </li>
              <li className="group flex justify-center">
                <Link
          ...
          <section className="flex justify-center items-center hover:text-[#0E72E8]">
